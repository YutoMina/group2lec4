package oit.is.group2.lec4.group2lec4.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user1 = users
        .username("user1")
        .password("$2y$10$zJ5SkaVZGVF8fTEiQrcgwORwZoX.RgD/seqimn00D7xkbqVoSKzgO")
        .roles("USER")
        .build();
    UserDetails admin = users
        .username("admin")
        .password("$2y$10$1pO723L7w6gqu57j/D236eo05HkWZSM7nN/6lZQn6AMq2RbZsMVEO")
        .roles("ADMIN")
        .build();
